...
const StandingsTable = ({ players, tournamentType, isLoading, onPlayerClick, results, tournament }) => {
  ...
  if (isLoading) {
    return (
      <div className="bg-card/90 backdrop-blur-sm rounded-lg border border-border/20 p-4 sm:p-8">
  ...
  if (!sortedPlayers || sortedPlayers.length === 0) {
    return (
      <div className="bg-card/90 backdrop-blur-sm rounded-lg border border-border/20 p-8 sm:p-12 text-center">
  ...
  return (
    <div className="bg-card/90 backdrop-blur-sm rounded-lg border border-border/20 overflow-hidden">
