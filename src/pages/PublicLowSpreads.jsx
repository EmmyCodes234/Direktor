...
const PublicLowSpreads = () => {
    ...
    const statsData = useMemo(() => {
        ...
        return matches
            ...
            .sort((a, b) => a.spread - b.spread) // Sort by Spread ASC (Low Spreads)
            .slice(0, 100);
            ...
            <div className="py-4 md:py-8 max-w-5xl mx-auto px-2 md:px-4">
                <div className="relative flex flex-col md:flex-row items-center justify-center mb-6 md:mb-8 gap-2">
                    ...
                    <div className="text-center">
                        <h2 className="text-xl md:text-2xl font-bold font-serif">Nailbiters</h2>
                        <p className="text-xs md:text-sm text-gray-500 mt-1 font-sans">Matches decided by the smallest margins.</p>
                    </div>
                </div>
                    ...
                    <table className="w-full text-xs md:text-sm border-collapse font-sans min-w-[350px] md:min-w-[600px]">
                        <thead>
                            <tr className="text-center font-bold text-xs md:text-base border-b border-gray-200 bg-gray-50">
                                ...
                                <th className="p-1 md:p-2 pb-2 md:pb-3">Spread</th>
...
export default PublicLowSpreads;
