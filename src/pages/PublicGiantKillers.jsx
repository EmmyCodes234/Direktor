            ...
            <div className="py-4 md:py-8 max-w-5xl mx-auto px-2 md:px-4">
                <div className="relative flex flex-col md:flex-row items-center justify-center mb-6 md:mb-8 gap-2">
                    ...
                    <div className="text-center">
                        <h2 className="text-xl md:text-2xl font-bold font-serif">Giant Killers</h2>
                        <p className="text-xs md:text-sm text-gray-500 mt-1 font-sans">Lower-rated players defeating higher-rated opponents.</p>
                    </div>
                </div>
