...
const PublicLowLosses = () => {
    ...
    const statsData = useMemo(() => {
        ...
        return matches
            ...
            .sort((a, b) => a.loserScore - b.loserScore) // Sort by Losing Score ASC (Low Losses)
            .slice(0, 100);
        ...
        <div className="min-h-screen bg-white text-black font-sans">
            ...
            <div className="py-4 md:py-8 max-w-5xl mx-auto px-2 md:px-4">
                <div className="relative flex flex-col md:flex-row items-center justify-center mb-6 md:mb-8 gap-2">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold font-serif text-center">Cold Spells</h2>
                </div>
...
export default PublicLowLosses;
