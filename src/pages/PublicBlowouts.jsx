...
const PublicBlowouts = () => {
    ...
    const statsData = useMemo(() => {
        ...
        return matches
            ...
            .sort((a, b) => b.spread - a.spread) // Sort by Spread DESC (Blowouts)
            .slice(0, 100);
                        ...
                        <tbody>
                            {statsData.map((match, idx) => (
                                <tr key={match.id || idx} className="hover:bg-gray-50 border-b border-gray-100 last:border-0">
                                    ...
                                    <td className="p-1 md:p-2 text-center font-mono font-bold text-green-700 bg-green-50/30">
                                        +{match.spread}
                                    </td>
