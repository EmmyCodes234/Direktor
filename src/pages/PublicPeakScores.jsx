...
const PublicPeakScores = () => {
    ...
    const statsData = useMemo(() => {
        ...
        return matches
            ...
            .sort((a, b) => b.winnerScore - a.winnerScore) // Sort by Winning Score DESC
            .slice(0, 100);
            ...
            <div className="py-4 md:py-8 max-w-5xl mx-auto px-2 md:px-4">
                <div className="relative flex flex-col md:flex-row items-center justify-center mb-6 md:mb-8 gap-2">
                    ...
                    <div className="text-center">
                        <h2 className="text-xl md:text-2xl font-bold font-serif">Peak Scores</h2>
                        <p className="text-xs md:text-sm text-gray-500 mt-1 font-sans">Highest individual game scores recorded.</p>
                    </div>
                </div>
...
export default PublicPeakScores;
