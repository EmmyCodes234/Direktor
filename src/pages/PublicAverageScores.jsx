...
const PublicAverageScores = () => {
    ...
    const statsData = useMemo(() => {
        ...
        return players.map(player => {
            ...
            const avgScore = gamesPlayed > 0 ? (totalMyScore / gamesPlayed) : 0;
            ...
            return {
                ...
                avgScore,
                gamesPlayed,
                record: `${points.toFixed(1)}-${losses.toFixed(1)}`, // "Won-Lost" column format
                spread,
                spreadDisplay: spread > 0 ? `+${spread}` : `${spread}`
            };
        }).sort((a, b) => {
            // Sort by Avg Score DESCENDING (Higher is better)
            ...
            <div className="py-4 md:py-8 max-w-4xl mx-auto px-2 md:px-4">
                <div className="relative flex flex-col md:flex-row items-center justify-center mb-6 md:mb-8 gap-2">
                    ...
                    <div className="text-center">
                        <h2 className="text-xl md:text-2xl font-bold font-serif">Scoring Pace</h2>
                        <p className="text-xs md:text-sm text-gray-500 mt-1 font-sans">Average game score distribution per player.</p>
                    </div>
                </div>
                    ...
                    <table className="w-full text-xs md:text-sm border-collapse font-sans min-w-[320px]">
                        <thead>
                            <tr className="text-center font-bold text-xs md:text-base border-b border-gray-200 bg-gray-50">
                                ...
                                <th className="p-1 md:p-2 pb-2 md:pb-4 leading-tight">Average<br />Score</th>
...
export default PublicAverageScores;
