-- Fix player stats by recalculating from results
-- This script will reset and recalculate wins, losses, ties, and spread for all players
...
-- Then recalculate stats from results
